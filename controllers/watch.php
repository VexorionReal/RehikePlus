...
return new class extends NirvanaController {
    ...
    public function tryGetSpfData(?object &$data): bool
    {
        ...
        if ("PLAYER_2014" != Config::getConfigProp("appearance.playerChoice") && "PLAYER_2015" != Config::getConfigProp("appearance.playerChoice") && "PLAYER_2015_NEW" != Config::getConfigProp("appearance.playerChoice") && "PLAYER_2017" != Config::getConfigProp("appearance.playerChoice"))
        {
